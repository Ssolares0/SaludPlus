...
- Gestión de citas
  ...
  - Atención de pacientes (estados: pendientes, en proceso, finalizadas)
  - Canelación de citas
- Configuración
  - Horarios de atención
  - Gestión de historial de atención
...
- Reportería
  - Generación de reporetes estadísticos
...
- cpacidad para manejar usuarios concurrentes

#### Disponiblidad

- Sistema desponible al 99%
